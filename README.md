...
![My Skills](https://skillicons.dev/icons?i=laravel,nodejs,python,java,vue,c,html,css,js,ts)

![My Skills](https://skillicons.dev/icons?i=mysql,postgres,redis,mongodb,docker,kafka,git)
